...
***** Test the coffee machine for state 0 and one time 10 cents
...
***** Test the coffee machine for state 0 and one time 20 cents
Define Sta: coffee_machine.State;
       Re: coffee_machine.Reaction;
       Expected_Reaction: coffee_machine.Reaction := Nothing;
       Actual_Reaction: coffee_machine.Reaction;
...
***** Test the coffee machine for state 1 one time 10 cents
Define Sta: coffee_machine.State;
       Re: coffee_machine.Reaction;
       Expected_Reaction: coffee_machine.Reaction := Nothing;
       Actual_Reaction: coffee_machine.Reaction;
...
***** Test the coffee machine for state 1 one time 20 cents
Define Sta: coffee_machine.State;
       Re: coffee_machine.Reaction;
...
***** Test the coffee machine for state 2 one time 10 cents
Define Sta: coffee_machine.State;
       Re: coffee_machine.Reaction;
       Expected_Reaction: coffee_machine.Reaction := Coffee;
       Actual_Reaction: coffee_machine.Reaction;
...
***** Test the coffee machine for state 2 one time 20 cents
Define Sta: coffee_machine.State;
       Re: coffee_machine.Reaction;
       Expected_Reaction: coffee_machine.Reaction := Coffee;
       Actual_Reaction: coffee_machine.Reaction;
...
***** Test the coffee machine for no cents and then pressing button
Define Sta: coffee_machine.State;
       Re: coffee_machine.Reaction;
       Expected_Reaction: coffee_machine.Reaction := Nothing;
       Actual_Reaction: coffee_machine.Reaction;
...
***** Test the coffee machine for one times 20 cents and then pressing button
Define Sta: coffee_machine.State;
       Re: coffee_machine.Reaction;
       Expected_Reaction: coffee_machine.Reaction := Drop_All_Coins;
       Actual_Reaction: coffee_machine.Reaction;
...
***** Test the coffee machine for all other cases
Define Sta: coffee_machine.State;
       Re: coffee_machine.Reaction;
       Expected_Reaction: coffee_machine.Reaction := Nothing;
       Actual_Reaction: coffee_machine.Reaction;
...
***** Test the coffee machine for initializing
Define Sta: coffee_machine.State;
       Re: coffee_machine.Reaction;
       Expected_Reaction: coffee_machine.Reaction := Nothing;
       Actual_Reaction: coffee_machine.Reaction;
